...
>(({ className, ...props }, ref) => (
    <div className="flex items-center border-b px-3" cmdk-input-wrapper="">
        ...
        <CommandPrimitive.Input
            ref={ref}
            className={cn(
                'placeholder:text-muted-foreground flex h-11 w-full rounded-md border-transparent bg-transparent py-3 text-sm ring-0 outline-hidden focus-visible:border-transparent focus-visible:ring-0 focus-visible:shadow-none disabled:cursor-not-allowed disabled:opacity-50',
                className,
            )}
            {...props}
        />
